...
from ...wordcount import preprocess_lines
from ...wordcount import split_into_words
from ...wordcount import count_words
from ...wordcount import write_word_counts           
...
def test_parse_args():
    ...
    assert input_folder == test_args[1] # "data/input/"  
    assert output_folder == test_args[2] # "data/output/"   
